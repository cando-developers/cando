...
SMART(IntegerKeyObjectDictionary);
    class IntegerKeyObjectDictionary_O : public core::T_O
{
    LISP_BASE1(core::T_O);
    LISP_CLASS(candoBase,CandoBasePkg,IntegerKeyObjectDictionary_O,"IntegerKeyObjectDictionary");
public:
...
TRANSLATE(candoBase::IntegerKeyObjectDictionary_O);
