...
(defun tool-orient-principle-axis-along-coordinate-axis (unit)
  (let* ((unit-center (chem:geometric-center unit))
         ...
         (diagnoalize (geom:make-matrix-identity))
    ...
    (math-op-diagonalize moment eigen-values diagnoalize)
    (let* ((diagnoalize-0 (geom:vec (geom:at-row-col-get diagnoalize 0 0)
                                    (geom:at-row-col-get diagnoalize 0 1)
                                    (geom:at-row-col-get diagnoalize 0 2)))
           (diagnoalize-1 (geom:vec (geom:at-row-col-get diagnoalize 1 0)
                                    (geom:at-row-col-get diagnoalize 1 1)
                                    (geom:at-row-col-get diagnoalize 1 2)))
           (diagnoalize-2 (geom:vec (geom:at-row-col-get diagnoalize 2 0)
                                    (geom:at-row-col-get diagnoalize 2 1)
                                    (geom:at-row-col-get diagnoalize 2 2)))
           (pos (geom:vcross diagnoalize-0 diagnoalize-1))
           (dot (geom:vdot pos diagnoalize-2)))
      (format t "The handedness of the transformation is (+1=Right): ~a~%" dot)
      ;;If the handedness of the matrix is wrong then change it
      (if (< dot 0.0)
          (progn
            (geom:at-row-col-put diagnoalize 2 0 (* (geom:at-row-col-get diagnoalize 2 0) -1.0))
            (geom:at-row-col-put diagnoalize 2 1 (* (geom:at-row-col-get diagnoalize 1 0) -1.0))
            (geom:at-row-col-put diagnoalize 2 2 (* (geom:at-row-col-get diagnoalize 2 0) -1.0))))
       ...
       (lambda (atom)
         (let ((atom-position (chem:get-position atom)))
           (geom:set-all3 atom-position
                          (+ (* (geom:at-row-col-get diagnoalize 0 0) (geom:vx atom-position))
                             (* (geom:at-row-col-get diagnoalize 1 0) (geom:vy atom-position))
                             (* (geom:at-row-col-get diagnoalize 2 0) (geom:vz atom-position)))
                          (+ (* (geom:at-row-col-get diagnoalize 0 1) (geom:vx atom-position))
                             (* (geom:at-row-col-get diagnoalize 1 1) (geom:vy atom-position))
                             (* (geom:at-row-col-get diagnoalize 2 1) (geom:vz atom-position)))
                          (+ (* (geom:at-row-col-get diagnoalize 0 2) (geom:vx atom-position))
                             (* (geom:at-row-col-get diagnoalize 1 2) (geom:vy atom-position))
                             (* (geom:at-row-col-get diagnoalize 2 2) (geom:vz atom-position))))
           #+(or)(geom:set-all3 atom-position
                          (geom:vx (geom:m*v diagnoalize atom-position))
                          (geom:vy (geom:m*v diagnoalize atom-position))
                          (geom:vz (geom:m*v diagnoalize atom-position)))
