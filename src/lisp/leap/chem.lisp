...
(defun parse-ptor-line (line)
  (flet ((not-white-space-p (c) (char>= c #\!))
    ...
    (let* ((atom1-name (string-trim " " (subseq line 0 2)))
           ...
           (divider (fortran::parse-vecreal (subseq line divider-start divider-end)))
           ...
           (barrier (fortran::parse-vecreal (subseq line barrier-start barrier-end)))
           ...
           (phase-deg (fortran::parse-vecreal (subseq line phase-start phase-end)))
           ...
           (periodicity (fortran::parse-vecreal (subseq line periodicity-start periodicity-end)))
