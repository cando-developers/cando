...
(asdf:load-asd (merge-pathnames #P"smarts/language.smiles.asd" *load-pathname*))
(asdf:load-asd (merge-pathnames #P"smarts/language.smarts.asd" *load-pathname*))
...
(asdf:load-asd (merge-pathnames #P"load-cando.asd" *load-pathname*))
(ql:quickload "load-cando" :verbose t)
