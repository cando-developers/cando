...
;        (print (% "test1 on %s" (description a)))
         do (when (matches *rule1a* a)
           (set-aromaticity-type a 'ar6 'rule1))
         ))

(defparameter *ar6test* (list 'ar6 (lambda (a) (= (chem:matter-get-property-or-default a 'aromaticity nil) 'ar6))))
...
(defparameter *ar67test* (list 'ar67 (lambda (a) (or (= (chem:matter-get-property-or-default a 'aromaticity nil) 'ar6)
                                               (= (chem:matter-get-property-or-default a 'aromaticity nil) 'ar7)))))
