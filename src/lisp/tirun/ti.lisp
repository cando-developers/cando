...
(defmethod script ((file getdvdl-script-file))
  (read-file (translate-logical-pathname (script-file file))))
...
(defclass morph-side-stage-getdvdl-job (morph-side-stage-job getdvdl-job-mixin)
  ())
