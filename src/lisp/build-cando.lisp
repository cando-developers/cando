...
(asdf:load-asd (merge-pathnames #P"cando/smarts/language.smiles.asd" *load-pathname*))
(asdf:load-asd (merge-pathnames #P"cando/smarts/language.smarts.language-server.asd" *load-pathname*))
(asdf:load-asd (merge-pathnames #P"cando/smarts/language.smarts.asd" *load-pathname*))
...
(asdf:load-asd (merge-pathnames #P"design/design.asd" *load-pathname*))
