            ...
            do (loop with atagg = (ataggregate conf)
                     ...
                     when (or (null monomers)
                       ...
                       do (let* ((monomer-context (gethash monomer (monomer-contexts conf)))
                                 (fragment-conformations (let ((frag (gethash monomer-context (monomer-context-to-fragment-conformations fragments))))
                                                           (unless frag
                                 ...
                                 (fragment-internals (let ((fragments (fragments fragment-conformations)))
