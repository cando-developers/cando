...
{_G();
int		ia;
this->_FixedCoordinates = addon::CoordinateArray_O::create(this->_SuperposeAtoms.size());
...
Matrix					transform;
int					i;
addon::CoordinateArray_sp			moveableCoordinates;
	...
	//
    moveableCoordinates= addon::CoordinateArray_O::create(this->_SuperposeAtoms.size());
