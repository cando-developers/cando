...
//	void	archiveBase(core::ArchiveP node);
	...
	void	setAliasesFromSymbolList(core::SymbolList_sp aliases);
	void	setAliasesFromCons(core::Cons_sp aliases);
...
//	void	updateGroupName() { this->_expandGroupName(); };
    ...
    public:
        ...
        virtual core::SymbolList_sp allAtomAliases();
