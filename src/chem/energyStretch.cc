...
#include <cando/chem/_Stretch_debugEvalSerialize.cc>
#endif //]
    }
#endif
...
#pragma clang diagnostic push
#pragma GCC diagnostic ignored "-Wunused-variable"
#include <cando/chem/_Stretch_termDeclares.cc>
...
#pragma clang diagnostic pop
	...
	double fz2 = 0.0;
#endif
#include <cando/chem/_Stretch_termCode.cc>
...
#include <cando/chem/_Stretch_debugEvalSet.cc>
#endif //]
		if ( this->_DebugEnergy ) {
...
#include <cando/chem/_Stretch_termCode.cc>
		    ...
		    LOG(BF("y2 = %le") % y2  );
		    LOG(BF("z2 = %le") % z2  );
#include <cando/chem/_Stretch_debugFiniteDifference.cc>
		}
	    }
	}
    }
