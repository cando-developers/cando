...
public:
	...
	Atom_sp		getAtom() { return downcast<Atom_O>(this->currentObject); }
	Residue_sp	getResidue() { return downcast<Residue_O>(this->currentObject); }
	Molecule_sp	getMolecule() { return downcast<Molecule_O>(this->currentObject); }
