...
double energy(const linear_angle_term& term, double* position, double* energy_accumulate) {
  double energy_added = 0.0;
  {
    ...
    DOUBLE z3 = position[term.i3x3 + 2];
    {
      ...
      double energy = (term.kt * (1.0 + cos_theta));
      energy_added += energy;
...
double hessian(const linear_angle_term& term, double* position, double* energy_accumulate, double* force, HESSIAN hessian, double* dvec, double* hdvec) {
  double energy_added = 0.0;
  {
    ...
    DOUBLE z3 = position[term.i3x3 + 2];
    {
      ...
      double cse_p729_t1_sqrt253 = sqrt(n1_sq);
      double cse_p729_t2_invr254 = (1.0 / (n1_sq));
      double cse_p61_t3_invr2125 = (cse_p729_t2_invr254 * cse_p729_t2_invr254);
      ...
      double cse_p729_t3_sqrt255 = sqrt(n2_sq);
      double cse_p729_t4_invr256 = (1.0 / (n2_sq));
      double cse_p61_t6_invr2128 = (cse_p729_t4_invr256 * cse_p729_t4_invr256);
      double cse_p11_t1_g103 = (cse_p729_t3_sqrt255 * cse_p729_t4_invr256);
      double cse_p11_t43_g49 = (cse_p11_t1_g103 * cse_p64_t1_g156);
      double cse_p116_t1_g193 = (cse_p11_t1_g103 * cse_p729_t2_invr254);
      ...
      double cse_p1_t2_invsqrt2 = (1.0 / (cse_p729_t1_sqrt253));
      double n1 = cse_p729_t1_sqrt253;
      double cse_p62_t1_g132 = (cse_p11_t1_g103 * n1);
      double cse_p63_t1_g143 = (cse_p729_t3_sqrt255 * n1);
      double cse_p63_t1_g148 = (cse_p61_t6_invr2128 * cse_p63_t1_g143);
      double cse_p65_t1_g165 = (2.0 * cse_p63_t1_g148);
      ...
      double cse_p64_t1_g154 = (cse_p62_t1_g132 * cse_p729_t4_invr256);
      ...
      double cse_p1_t4_invsqrt4 = (1.0 / (cse_p729_t3_sqrt255));
      double n2 = cse_p729_t3_sqrt255;
      double cse_p63_t1_g146 = (cse_p729_t1_sqrt253 * n2);
      double cse_p63_t1_g149 = (-2.0 * cse_p61_t3_invr2125);
      double cse_p114_t1_g182 = (cse_p63_t1_g146 * cse_p63_t1_g149);
      double cse_p11_t1_g106 = (cse_p63_t1_g146 * cse_p729_t2_invr254);
      ...
      double cse_p65_t1_g168 = (cse_p729_t2_invr254 * n2);
      double cse_p116_t1_g194 = (cse_p65_t1_g168 * cse_p729_t2_invr254);
      ...
      double cse_p11_t9_g15 = (2.0 * cse_p1_t5_invr5);
      ...
      *energy_accumulate += energy;
      ...
      KernelGradientAcc(term.i3x3, 2, g_z3);
      double cse_p11_t1_g104 = (cse_p729_t1_sqrt253 * cse_p729_t2_invr254);
      double cse_p11_t1_g107 = (cse_p11_t1_g104 * n2);
      double cse_p166_t1_g214 = (cse_p11_t1_g107 * cse_p729_t2_invr254);
      double cse_p63_t7_g139 = (cse_p114_t1_g182 + cse_p166_t1_g214);
      double cse_p11_t1_g109 = (cse_p61_t8_invr2130 * dot);
      double cse_p117_t1_g208 = (2.0 * cse_p11_t1_g109);
      ...
      double cse_p115_t1_g192 = (cse_p11_t1_g109 * cse_p729_t1_sqrt253);
      ...
      double cse_p63_t2_g134 = (cse_p63_t1_g150 * cse_p729_t4_invr256 * dot);
      ...
      double cse_p65_t1_g164 = (-2.0 * cse_p63_t1_g148);
      double cse_p116_t1_g197 = (cse_p11_t49_g55 * cse_p63_t1_g142);
      double h_x2_x2 = (term.kt * (cse_p11_t9_g15 + (2.0 * cse_p11_t57_g63 * cse_p11_t60_g66) + (dot * ((cse_p116_t1_g197 * cse_p11_t49_g55) + (-((cse_p61_t8_invr2130 * (cse_p11_t20_g26 + cse_p62_t1_g132 + (cse_p114_t1_g182 * cse_p64_t1_g155) + (cse_p11_t1_g104 * (cse_p11_t33_g39 + cse_p11_t43_g49 + cse_p11_t43_g49 + n2)) + (cse_p64_t1_g157 * cse_p65_t1_g164)))))))));
      ...
      double h_z2_z2 = (term.kt * (cse_p11_t9_g15 + (2.0 * cse_p11_t59_g65 * cse_p11_t62_g68) + (dot * ((cse_p11_t51_g57 * cse_p11_t51_g57 * cse_p63_t1_g142) + (-((cse_p61_t8_invr2130 * (cse_p11_t30_g36 + cse_p62_t1_g132 + (cse_p114_t1_g182 * cse_p64_t1_g161) + (cse_p11_t1_g104 * (cse_p11_t42_g48 + cse_p11_t47_g53 + cse_p11_t47_g53 + n2)) + (cse_p65_t1_g163 * cse_p65_t1_g164)))))))));
      ...
      double cse_p11_t1_g112 = (cse_p11_t1_g109 * cse_p62_t1_g132 * cse_p729_t4_invr256);
      double cse_p115_t1_g191 = (-2.0 * cse_p115_t1_g184);
