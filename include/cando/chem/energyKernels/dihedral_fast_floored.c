...
double gradient(const dihedral_term& term, double* position, double* energy_accumulate, double* force) {
  double energy_added = 0.00000000000000000e+0;
  {
    ...
    DOUBLE z4 = position[term.i3x4 + 2];
    {
      ...
      double cse_p12_t1_g3 = (1.00000000000000000e+0 + pp);
      double qq = (cse_p1_t2_invr2 * ((v2x * v3x) + (v2y * v3y) + (v2z * v3z)));
      double cse_p12_t2_g4 = (1.00000000000000000e+0 + qq);
      double d1x = (c1x * (-(g1)));
      double d1y = (c1y * (-(g1)));
      double d1z = (c1z * (-(g1)));
      double d4x = (c2x * g4);
      ...
      energy_added += energy;
      *energy_accumulate += energy;
      double cse_p12_t1_g5 = (term.n * sin_angle * (-(term.v)));
      double g_x1 = (cse_p12_t1_g5 * d1x);
      KernelGradientAcc(term.i3x1, 0, g_x1);
      double g_y1 = (cse_p12_t1_g5 * d1y);
      KernelGradientAcc(term.i3x1, 1, g_y1);
      double g_z1 = (cse_p12_t1_g5 * d1z);
      KernelGradientAcc(term.i3x1, 2, g_z1);
      double g_x2 = (cse_p12_t1_g5 * ((d4x * qq) + (-((cse_p12_t1_g3 * d1x)))));
      KernelGradientAcc(term.i3x2, 0, g_x2);
      double g_y2 = (cse_p12_t1_g5 * ((d4y * qq) + (-((cse_p12_t1_g3 * d1y)))));
      KernelGradientAcc(term.i3x2, 1, g_y2);
      double g_z2 = (cse_p12_t1_g5 * ((d4z * qq) + (-((cse_p12_t1_g3 * d1z)))));
      KernelGradientAcc(term.i3x2, 2, g_z2);
      double g_x3 = (cse_p12_t1_g5 * ((d1x * pp) + (-((cse_p12_t2_g4 * d4x)))));
      KernelGradientAcc(term.i3x3, 0, g_x3);
      double g_y3 = (cse_p12_t1_g5 * ((d1y * pp) + (-((cse_p12_t2_g4 * d4y)))));
      KernelGradientAcc(term.i3x3, 1, g_y3);
      double g_z3 = (cse_p12_t1_g5 * ((d1z * pp) + (-((cse_p12_t2_g4 * d4z)))));
      KernelGradientAcc(term.i3x3, 2, g_z3);
      double g_x4 = (cse_p12_t1_g5 * d4x);
      KernelGradientAcc(term.i3x4, 0, g_x4);
      double g_y4 = (cse_p12_t1_g5 * d4y);
      KernelGradientAcc(term.i3x4, 1, g_y4);
      double g_z4 = (cse_p12_t1_g5 * d4z);
...
double hessian(const dihedral_term& term, double* position, double* energy_accumulate, double* force, HESSIAN hessian, double* dvec, double* hdvec) {
  double energy_added = 0.00000000000000000e+0;
  {
    ...
    DOUBLE z4 = position[term.i3x4 + 2];
    {
      ...
      double d1x = (c1x * (-(g1)));
      double cse_p12_t1_g3 = (cse_p12_t19_g21 * d1x);
      double cse_p12_t2_g4 = (d1x * pp);
      double cse_p12_t21_g23 = (-(cse_p12_t1_g3));
      double d1y = (c1y * (-(g1)));
