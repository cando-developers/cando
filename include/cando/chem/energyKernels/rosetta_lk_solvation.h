...
struct rosetta_lk_solvation_term {
  ...
  rosetta_lk_solvation_term(const rosetta_lk_solvation_parameters& params, double lk_dgfree_i, double lk_lambda_i, double lj_radius_i, double lk_volume_i, double lk_dgfree_j, double lk_lambda_j, double lj_radius_j, double lk_volume_j, int i3x1, int i3x2) {
    ...
    double inv2pi32 = (1.0 * (1.0 / ((2.0 * pi * sqrt(pi)))));
    ...
    double pref_i_j = (1.0 * lk_dgfree_i * lk_volume_j * (1.0 / (lk_lambda_i)) * (-(inv2pi32)));
    this->pref_i_j = pref_i_j;
    double pref_j_i = (1.0 * lk_dgfree_j * lk_volume_i * (1.0 / (lk_lambda_j)) * (-(inv2pi32)));
    ...
    this->f_r1_i = f_r1_i;
    double df_r1_i = (-2.0 * f_r1_i * ((1.0 * (1.0 / (r1_low))) + (delta_r1_i * (1.0 / (lambda2_i)))));
    ...
    this->f_r1_j = f_r1_j;
    double df_r1_j = (-2.0 * f_r1_j * ((1.0 * (1.0 / (r1_low))) + (delta_r1_j * (1.0 / (lambda2_j)))));
    ...
    this->f_r2_i = f_r2_i;
    double df_r2_i = (-2.0 * f_r2_i * ((1.0 * (1.0 / (r2_high))) + (delta_r2_i * (1.0 / (lambda2_i)))));
    ...
    this->f_r2_j = f_r2_j;
    double df_r2_j = (-2.0 * f_r2_j * ((1.0 * (1.0 / (r2_high))) + (delta_r2_j * (1.0 / (lambda2_j)))));
    this->df_r2_j = df_r2_j;
    double aa_low_i_shift = (((-2.0 * f_r1_i) + (2.0 * f_contact_i) + (df_r1_i * dr_low)) * (1.0 / ((dr_low * dr_low * dr_low))));
    double bb_low_i_shift = (((-3.0 * f_contact_i) + (3.0 * f_r1_i) + (-((df_r1_i * dr_low)))) * (1.0 / ((dr_low * dr_low))));
    double cc_low_i_shift = 0.0;
    double dd_low_i_shift = f_contact_i;
    double aa_low_j_shift = (((-2.0 * f_r1_j) + (2.0 * f_contact_j) + (df_r1_j * dr_low)) * (1.0 / ((dr_low * dr_low * dr_low))));
    double bb_low_j_shift = (((-3.0 * f_contact_j) + (3.0 * f_r1_j) + (-((df_r1_j * dr_low)))) * (1.0 / ((dr_low * dr_low))));
    double cc_low_j_shift = 0.0;
    double dd_low_j_shift = f_contact_j;
    double aa_low_i = aa_low_i_shift;
    this->aa_low_i = aa_low_i;
    double bb_low_i = (bb_low_i_shift + (-3.0 * aa_low_i_shift * r0_low));
    this->bb_low_i = bb_low_i;
    double cc_low_i = (cc_low_i_shift + (-2.0 * bb_low_i_shift * r0_low) + (3.0 * aa_low_i_shift * r0_low * r0_low));
    ...
    double bb_low_j = (bb_low_j_shift + (-3.0 * aa_low_j_shift * r0_low));
    this->bb_low_j = bb_low_j;
    double cc_low_j = (cc_low_j_shift + (-2.0 * bb_low_j_shift * r0_low) + (3.0 * aa_low_j_shift * r0_low * r0_low));
    ...
    double aa_high_i_shift = (((2.0 * f_r2_i) + (df_r2_i * dr_high)) * (1.0 / ((dr_high * dr_high * dr_high))));
    double bb_high_i_shift = (((-2.0 * df_r2_i * dr_high) + (-3.0 * f_r2_i)) * (1.0 / ((dr_high * dr_high))));
    double cc_high_i_shift = df_r2_i;
    double dd_high_i_shift = f_r2_i;
    double aa_high_j_shift = (((2.0 * f_r2_j) + (df_r2_j * dr_high)) * (1.0 / ((dr_high * dr_high * dr_high))));
    double bb_high_j_shift = (((-2.0 * df_r2_j * dr_high) + (-3.0 * f_r2_j)) * (1.0 / ((dr_high * dr_high))));
    double cc_high_j_shift = df_r2_j;
    double dd_high_j_shift = f_r2_j;
    double aa_high_i = aa_high_i_shift;
    this->aa_high_i = aa_high_i;
    double bb_high_i = (bb_high_i_shift + (-3.0 * aa_high_i_shift * r2_high));
    this->bb_high_i = bb_high_i;
    double cc_high_i = (cc_high_i_shift + (-2.0 * bb_high_i_shift * r2_high) + (3.0 * aa_high_i_shift * r2_high * r2_high));
    ...
    double bb_high_j = (bb_high_j_shift + (-3.0 * aa_high_j_shift * r2_high));
    this->bb_high_j = bb_high_j;
    double cc_high_j = (cc_high_j_shift + (-2.0 * bb_high_j_shift * r2_high) + (3.0 * aa_high_j_shift * r2_high * r2_high));
