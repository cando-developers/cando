  ...
  double energy_added = 0.0;
  {
    ...
    DOUBLE z1 = position[term.i3x1 + 2];
    {
      ...
      if ((rr <= term.r0)) {
        ...
        energy_added += energy;
        *energy_accumulate += energy;
        double cse_p1038_t1_invr11098 = (1.0 / (rr));
        double g_x1 = (cse_p1038_t1_invr11098 * de_dr * dx);
        KernelGradientAcc(term.i3x1, 0, g_x1);
        double g_y1 = (cse_p1038_t1_invr11098 * de_dr * dy);
        KernelGradientAcc(term.i3x1, 1, g_y1);
        double g_z1 = (cse_p1038_t1_invr11098 * de_dr * dz);
  ...
  double energy_added = 0.0;
  {
    ...
    DOUBLE z1 = position[term.i3x1 + 2];
    {
      ...
      if ((rr <= term.r0)) {
        ...
        double cse_p988_t1_invr21302 = (1.0 / ((rr * rr * rr)));
        double cse_p988_t2_invr21303 = (1.0 / (rr));
        ...
        double de_dr = 0.0;
        double cse_p60_t5_g1406 = (cse_p988_t1_invr21302 * de_dr);
        ...
        double d2e_dr2 = 0.0;
        double cse_p60_t1_g1429 = (cse_p988_t2_invr21303 * cse_p988_t2_invr21303 * d2e_dr2);
        ...
        energy_added += energy;
        *energy_accumulate += energy;
        double cse_p11_t1_g11 = (cse_p988_t2_invr21303 * de_dr * dy);
        double cse_p11_t2_g12 = (cse_p988_t2_invr21303 * de_dr * dz);
        double g_x1 = (cse_p988_t2_invr21303 * de_dr * dx);
        KernelGradientAcc(term.i3x1, 0, g_x1);
        ...
        /* !COND-ELSE-1 */
        {
          ...
          *energy_accumulate += energy;
          ...
          KernelGradientAcc(term.i3x1, 0, g_x1);
          double cse_p988_t2_invr21303 = (1.0 / (rr));
          double g_y1 = (cse_p988_t2_invr21303 * de_dr * dy);
          KernelGradientAcc(term.i3x1, 1, g_y1);
          double g_z1 = (cse_p988_t2_invr21303 * de_dr * dz);
          KernelGradientAcc(term.i3x1, 2, g_z1);
          double h_x1_x1 = ((cse_p988_t2_invr21303 * cse_p988_t2_invr21303 * d2e_dr2 * dx * dx) + (de_dr * ((rr * rr) + (-(cse_p11_t15_g25))) * (1.0 / ((rr * rr * rr)))));
          KernelHessDiagAcc( PositionSize, hessian, dvec, hdvec,  term.i3x1, 0, term.i3x1, 0, h_x1_x1);
          double cse_p988_t1_invr21302 = (1.0 / ((rr * rr * rr)));
          double cse_p60_t1_g1429 = (cse_p988_t2_invr21303 * cse_p988_t2_invr21303 * d2e_dr2);
          double cse_p11_t1_g52 = (rr * rr);
          double cse_p11_t1_g51 = (cse_p988_t1_invr21302 * de_dr);
