// XML_EVAL
	node->attributeIfNotDefault("evalx1", this->eval.x1, 0.0 );
 	...
 	node->attributeIfNotDefault("evalxb", this->eval.xb, 0.0 );
 	node->attributeIfNotDefault("evalyb", this->eval.yb, 0.0 );
 	node->attributeIfNotDefault("evalzb", this->eval.zb, 0.0 );
 	node->attributeIfNotDefault("evalka", this->eval.ka, 0.0 );
 	node->attributeIfNotDefault("evalra", this->eval.ra, 0.0 );
 	...
 	node->attributeIfNotDefault("evalPointToLineDeviation", this->eval.PointToLineDeviation, 0.0 );
