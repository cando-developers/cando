// XML_EVAL
	node->attributeIfNotDefault("evalx1", this->eval.x1, 0.0 );
 	...
 	node->attributeIfNotDefault("evalcrep", this->eval.crep, 0.0 );
 	node->attributeIfNotDefault("evalErep", this->eval.Erep, 0.0 );
 	...
 	node->attributeIfNotDefault("evalErepDistance", this->eval.ErepDistance, 0.0 );
