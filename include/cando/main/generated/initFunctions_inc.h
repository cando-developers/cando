...
NOINLINE void expose_function_109_helper() {
  expose_function(core::magic_name("gctools__mpsTelemetryReset"),true,&gctools::gctools__mpsTelemetryReset,"");
}
NOINLINE void expose_function_110_helper() {
  expose_function(core::magic_name("gctools__mpsTelemetrySet"),true,&gctools::gctools__mpsTelemetrySet,"");
}
