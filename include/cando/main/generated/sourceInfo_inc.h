...
NOINLINE void source_info_27_helper() {
 define_source_info( code_kind, core::magic_name("CHEM:save-pdb"), "../../src/chem/pdb.cc", 16608, 572, "" );
}
...
NOINLINE void source_info_1230_helper() {
 define_source_info( class_kind, core::magic_name("COMMON-LISP:pathname"), "/Volumes/spin/Development/clasp/include/clasp/core/pathname.h", 2756, 84, "" );
}
NOINLINE void source_info_1231_helper() {
 define_source_info( class_kind, core::magic_name("COMMON-LISP:logical-pathname"), "/Volumes/spin/Development/clasp/include/clasp/core/pathname.h", 5556, 151, "" );
}
