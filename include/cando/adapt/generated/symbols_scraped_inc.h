// Symbol table
// SYMBOL_TABLE_ENTRY     AdaptPkg    0 SymbolList_O                   SYMBOL-LIST                    export ; cName=_sym_SymbolList_O lispName=SYMBOL-LIST
// SYMBOL_TABLE_ENTRY     AdaptPkg    1 QDomNode_O                     QDOM-NODE                      export ; cName=_sym_QDomNode_O lispName=QDOM-NODE
...
DO_SYMBOL(_sym_QDomNode_O,1,AdaptPkg,"QDOM-NODE",true);
